<template>
    <div class="padding">
        ...
        <div class="text-sm">
            <div>
                <p class="padding-top">
                    Para esse primeiro post, eu pensei em algo que todo desenvolvedor precisa saber: <span class="italic">
                    como colocar um site no ar</span>?
                </p>
            ...
            <div>
                <a href="https://www.hover.com/" >
                    <p class="mt-8 font-semibold text-blue hover:underline pointer">
                        Hover
                    </p>
                </a>
                <p class="mt-3">
            ...
            <div>
                ...
                <p class="mt-3">
                    DigitalOcean nos permite alugar servidores. Resumindo: nos permite <spam class="italic">
                    alugar o espaço que o nosso website vai ficar na internet</spam>.
